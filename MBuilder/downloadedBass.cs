...
namespace MBuilder
{
    ...
    class downloadedBass : Activity
    {
        ...
        protected override void OnStart()
        {
            ...
            none.Click += delegate
            {
                menu.theSong.setBass(new track(null, null, 0, 0));
                Finish();
            };

            foreach (track i in bassTracks)
            {
                if (!(i == null))
                {
